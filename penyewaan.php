    ...
    <div class="row mt-5">
        <div class="col rounded shadow p-sm-4">
            <div class="row mb-sm-3">
                <div class="col">
                    <h4>Penyewaan</h4>
                    <small class="font-weight-light">Daftar alat yang akan/sedang anda sewa.</small>
                </div>
                <div class="col">
            ...
            ?>
            <div class="mt-4">
                <small class="d-block font-weight-light">* Anda harus datang ke tempat kami untuk mengambil alat,
                    pada tanggal menyewa yang anda tentukan.</small>
                <small class="d-block font-weight-light">* Alat yang disewa harus dikembalikan setelah mencapai lama
                    peminjaman, pada jam seperti waktu
                    pengambilan alat. jika tidak akan ada denda yang terhitung. </small>
                <small class="d-block font-weight-light">* Denda akan dihitung perjam sebesar total * 4.1666%, dimana
