    ...
    <div class="row mt-5">
        <div class="col p-sm-4">
            <div class="row mb-sm-3">
                <div class="col">
                    <h4>Daftar Alat Pendakian</h4>
                    <small class="font-weight-light">Silangkan pilih perlatan yang akan anda sewa.</small>
                </div>
            </div>
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th scope="col">Jumlah Ketersediaan</th>
            ...
            <form action="act-sewa.php" method="post">
                <div class="modal-body">
                    <div class="form-group">
                        <label class="col-form-label">Jumlah Penyewaan:</label>
