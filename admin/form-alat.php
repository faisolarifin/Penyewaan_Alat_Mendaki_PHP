...
if ($_POST) {
  ...
  if (!$error) {
    if (!$id) {
      ...
      echo "<script>alert('peralatan berhasil ditambahkan');window.location='./data-alat.php'</script>";
    }
    else {
      ...
      echo "<script>alert('peralatan berhasil diubah');window.location='./data-alat.php'</script>";
    }
  }
}
    ...
    <div class="row">
        <div class="col shadow p-sm-5 rounded">
            <div class="row mb-sm-3">
                <div class="col">
                    <h3><?= (@$id) ? 'Edit Alat' : 'Tambah Alat' ?></h3>
                </div>
                <div class="col text-right">
                    <a href="data-alat.php"><button class="btn btn-outline-primary">Data Alat >></button></a>
                </div>
            </div>
            ...
            <form method="post" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="nama" placeholder="Nama Alat" value="<?= @$data[1] ?>"
                        required>
                </div>
                <div class="form-group">
